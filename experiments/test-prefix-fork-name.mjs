...
const testCases = [
  {
    ...
    expected: {
      expectedForkName: 'petermotorniy/-',
      alternateForkName: 'petermotorniy/emirmensitov-afk--',
      defaultForkName: '-',
      actualForkName: 'petermotorniy/-',
    },
  },
  {
    ...
    currentUser: 'petermotorniy',
    expected: {
      expectedForkName: 'petermotorniy/emirmensitov-afk--',
      alternateForkName: 'petermotorniy/-',
      defaultForkName: 'emirmensitov-afk--',
      actualForkName: 'petermotorniy/emirmensitov-afk--',
    },
  },
  {
    ...
    currentUser: 'petermotorniy',
    expected: {
      expectedForkName: 'petermotorniy/vscode',
      alternateForkName: 'petermotorniy/microsoft-vscode',
      defaultForkName: 'vscode',
      actualForkName: 'petermotorniy/vscode',
    },
  },
  {
    ...
    currentUser: 'petermotorniy',
    expected: {
      expectedForkName: 'petermotorniy/microsoft-vscode',
      alternateForkName: 'petermotorniy/vscode',
      defaultForkName: 'microsoft-vscode',
      actualForkName: 'petermotorniy/microsoft-vscode',
    },
  },
];
