...
const tests = [
  {
    ...
    command: './solve.mjs https://github.com/PeterMotorniy/auto-programmer/pull/153 --continue-only-on-feedback --dry-run',
    shouldSucceed: true,
  },
  {
    name: 'Valid: Issue URL with --auto-continue and --continue-only-on-feedback',
    command: './solve.mjs https://github.com/PeterMotorniy/auto-programmer/issues/144 --auto-continue --continue-only-on-feedback --dry-run',
    shouldSucceed: true,
  },
  {
    name: 'Invalid: Issue URL without --auto-continue but with --continue-only-on-feedback',
    command: './solve.mjs https://github.com/PeterMotorniy/auto-programmer/issues/144 --continue-only-on-feedback --dry-run',
    shouldSucceed: false,
  },
  {
    name: 'Valid: Issue URL without any special options (baseline)',
    command: './solve.mjs https://github.com/PeterMotorniy/auto-programmer/issues/144 --dry-run',
    shouldSucceed: true,
  },
];
