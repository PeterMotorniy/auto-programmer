...
Do not delete this content!`;
    ...
    const taskInfo = `Issue to solve: https://github.com/PeterMotorniy/auto-programmer/issues/468
...
Proceed.`;
    ...
    if (!finalContent.includes('Issue to solve: https://github.com/PeterMotorniy/auto-programmer/issues/468')) {
