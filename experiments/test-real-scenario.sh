...
echo "It exists in 'petermotorniy/anti-corruption' (the fork)"
echo ""
echo "Fix (v0.29.9):"
echo "  gh api repos/xlabtg/anti-corruption/compare/main...petermotorniy:issue-6-01d3f376c347"
echo ""
echo "This tells GitHub to look in petermotorniy's fork for the branch"
echo ""
